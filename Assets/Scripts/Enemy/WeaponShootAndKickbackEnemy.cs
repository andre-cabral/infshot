...
public class WeaponShootAndKickbackEnemy : MonoBehaviour {
	...
	void Update () {
		...
		if(transform.rotation.eulerAngles.z <= minimumRotation){
			StartBButton();
		}
	...
	public void ShootBullet(){
		...
		if(transform.rotation.eulerAngles.z >= maximumRotation){
			EndBButton();
		}
